...
import com.adityamehrotra.tradesim.dto.LoginRequest;
import com.adityamehrotra.tradesim.dto.RegistrationRequest;
import com.adityamehrotra.tradesim.model.User;
import com.adityamehrotra.tradesim.repository.UserRepository;
import com.adityamehrotra.tradesim.service.UserService;
...
public class UserController {
  ...
  public ResponseEntity<?> updateFirstName(
      @RequestParam Integer userID, @RequestParam String firstName) {
    try {
  ...
  public ResponseEntity<?> updateLastName(
      @RequestParam Integer userID, @RequestParam String lastName) {
    try {
  ...
  public ResponseEntity<?> addPortfolio(
      @RequestParam Integer userID, @RequestParam Integer portfolioID) {
    try {
