...
import com.adityamehrotra.tradesim.service.HoldingService;
...
public class HoldingController {
  ...
  public ResponseEntity<?> buyHolding(@RequestBody UpdateHoldingRequest holding) {
    try {
      if (holding.getAction().equalsIgnoreCase("buy")
          || holding.getAction().equalsIgnoreCase("sell")) {
      ...
      return ResponseEntity.status(HttpStatus.OK)
          .body("Holding updated with ID: " + holding.getHoldingID());
    } catch (IllegalArgumentException e) {
